...
\hyphenation{crypto-gra-phy cla-ssic algo-rithms algo-rithm proce-ssing accele-ra-tion ins-truction bet-ween appli-cations commu-nication ope-rations proce-ssor gene-rally}
...
\title{\textcolor{blue}{Versatile RISC-V ISA Galois Field arithmetic extension for cryptography and error-correction codes}}
...
\begin{abstract}
  ...
  portable device processors must handle a wide range of algorithms. \textcolor{blue}{A tradeoff between speed and power consumption is required 
  ...
  processor's instruction set. In this work, a RISC-V instruction set for Galois field arithmetic is implemented and validated using SweRV-EL2 1.3 on a Nexys A7 FPGA.} 
  Performance in some algorithms \textcolor{blue}{like AES and Reed-Solomon} has been improved 
