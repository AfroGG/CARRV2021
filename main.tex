...
\title{RISC-V ISA Multiplication Extension for Galois Field arithmetic}
...
\begin{abstract}
  ...
  portable device processors must handle a wide range of algorithms. A tradeoff between speed and power consumption must be found to speed up 
  the execution time of a general-purpose processor. As $GF(2^m)$ arithmetic is the basis of many algorithms, 
  a RISC-V instruction set extension is proposed in this work. The hardware is implemented, and the 
